        ...
        <div className="prose prose-sm prose-neutral dark:prose-invert max-w-none space-y-8">
          <section>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              We collect information you provide directly to us, including company name, company stage, team size, operating challenges, AI tools used, planning constraints, and any contact information you choose to provide when booking a consultation or contacting us. Do not submit candidate, employee, applicant, protected-class, or personally sensitive employment data. We also automatically collect certain technical information when you visit our website, including your IP address, browser type, operating system, and browsing behavior through cookies and similar technologies.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              We use the information we collect to provide, maintain, and improve the Revenue Per Employee Planner; generate planning reports from self-reported organizational inputs; communicate with you about our services; respond to inquiries and schedule consultations; and analyze usage patterns to improve our website and service offerings.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              We do not sell, trade, or rent your personal information to third parties. We may share information with trusted service providers who assist us in operating our website, hosting the planning canvas, storing report data, and conducting our business, provided those parties agree to keep this information confidential. We may also disclose information when required by law or to protect our rights.
            </p>
          </section>

          <section>
            <h2 className="text-lg font-semibold mb-3">4. Planning Tool Boundaries</h2>
            <p className="text-sm text-muted-foreground leading-relaxed">
              The planning canvas is not designed to collect or process candidate, applicant, employee, protected-class, compensation, medical, background-check, or other sensitive employment data. It does not make employment decisions, screen candidates, evaluate employees, infer protected-class traits, or provide legal, HR, compensation, or compliance advice.
            </p>
          </section>
